...
open class RandomTools {
	...
	open class func randomElementFromArray<T>(_ array: Array<T>) -> T {
	...
	open class func randomElementFromArray<T>(_ elements: Array<T>, withCorespondingProbabilities probabilities: Array<Double>) -> T {
		...
		var accumulatedProbabilities: [Double] = Array<Double>(repeating: 0.0, count: count)
...
public extension Array
{
	...
	public func randomElements(count: Int) -> Array<Element> {
